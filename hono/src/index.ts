...
app.get('/api/news/technology', async (c) => {
  const techNewsResponse = await fetch('https://newsapi.org/v2/top-headlines?sources=techcrunch&apikey=7aa522a2df2f4d67acd9c6bc655fd297');
...
app.get('/api/news/latest', async (c) => {
  const newsApiResponse = await fetch('https://newsapi.org/v2/everything?q=technology&apiKey=7aa522a2df2f4d67acd9c6bc655fd297');
